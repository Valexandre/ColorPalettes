...
Rainbow_1<-c("#E7EAE3", "#FDDC5B", "#FEE1B9", "#FFE4D3", "#FCE9DB", "#FBEDE4", "#F6EBE7", "#F3E7EB", "#EBE8E3", "#E0EBED", "#DEE8E0", "#D2E9D9", "#D7E4AE")
Rainbow_2<-c("#E1E4DD", "#FACD10", "#FDD492", "#FFD5C2", "#FFDFD6", "#FBDED8", "#F1D3D5", "#E7DCE4", "#E1E2E6", "#D4E3EA", "#D1E2DC", "#BEE1CB", "#C8DC85")
Rainbow_3<-c("#C5C6C0", "#E1B401", "#FEB334", "#FD9C4F", "#FFA7A3", "#F5B9C1", "#E6BCC8", "#D5C4D7", "#CAD0DC", "#B2D2DF", "#B8D2D3", "#9DD3AF", "#A7CA4C")
Rainbow_4<-c("#ACAEAB", "#C99F19", "#EC961F", "#F9634B", "#F76566", "#E87C94", "#D8A1B8", "#BCACD0", "#A7B8D6", "#88BEDA", "#98C6C4", "#75BB97", "#96B859")
Rainbow_5<-c("#8D8F8E", "#9A7421", "#CA7A17", "#F8563F", "#E1414D", "#D65B77", "#B0789D", "#917EB6", "#6F96CF", "#4C9BC4", "#64A9A4", "#54976C", "#819C57")
Rainbow_6<-c("#686A69", "#7A632D", "#875017", "#B53F31", "#D0222C", "#B33855", "#825479", "#6F609B", "#3E6DC9", "#2E7AAB", "#528483", "#436950", "#58643E")
Rainbow_7<-c("#4F4F4F", "#4B432C", "#453418", "#6A2F21", "#8B131C", "#942454", "#56396F", "#4D3775", "#0243BB", "#2F6782", "#45686A", "#3A5044", "#47503B")
